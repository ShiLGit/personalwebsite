...
class Email extends Component{
    ...
    sendEmail=(e)=>{
        ...
        axios.post('http://localhost:5000/email/send', this.state.emailData)
        .then(res=>{
    ...
    render(){
        ...
        <div className={styles.Wrapper}>
            ...
            <form className={styles.Form} onSubmit={this.sendEmail}>
                ...
                <input type = "text" required value={this.state.emailData.senderName} onChange={this.onNameChange}></input>
                <br/>
                ...
                <br/>
                <label>Message</label>
                <textarea required value={this.state.emailData.emailBody}className={styles.TextArea} rows={10} onChange={this.onMessageChange}></textarea>
                <br/>
